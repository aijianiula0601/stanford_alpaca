...
def make_diff(
    ...
    kwargs = {"push_to_hub": True, "repo_id": ""}
...
def recover(
    ...
    Things to do before running this:
        ...
        3. Run this function with the correct paths. E.g.,
            ...
            python weight_diff.py recover --path_raw /vc_data_blob/caxu/Llama-X/model_weights/7B_hf --path_diff ./wizardlm7b --path_tuned ./wizardlm7b_recover
