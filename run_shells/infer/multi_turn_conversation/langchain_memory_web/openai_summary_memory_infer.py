...
if __name__ == '__main__':
    ...
    print('-' * 100)
    print(llama_memory_infer.infer(user_input="I am so sad, Audrey!"))
    print('-' * 100)
    print(llama_memory_infer.infer(user_input="I can't travel to India."))
    print('-' * 100)
    print(llama_memory_infer.infer(user_input="Are you going on a trip?"))
    print('-' * 100)
    print(llama_memory_infer.infer(user_input="When are you going to go? How can I get there?"))
