...
from run_shells.infer.multi_turn_conversation.web.gradio_model_self_chat_server import models_url_dic, \
    models_prompt_key_dic, models_list, mask_instruct, PROMPT_DICT
...
def update_select_role_b(role_b_key, user_name, select_role_b_model):
    background_a = prepared_role_b_dic[role_b_key]["background"].format_map(
        {"role_a": user_name,
         "role_b": prepared_role_b_dic[role_b_key]["role_name"]})
    examples_a = prepared_role_b_dic[role_b_key]["examples"].format_map(
        {"role_a": user_name,
         "role_b": prepared_role_b_dic[role_b_key]["role_name"]})

    input_prompt_b = PROMPT_DICT[models_prompt_key_dic[select_role_b_model]].format_map(
        {"background": background_a, "examples": examples_a, "role_a": user_name,
         "role_b": prepared_role_b_dic[role_b_key]["role_name"]})
