...
#----------------------------------------------------
# 加入gpt bigolive soda sex数据，城琦的训练方式
# 对应训练脚本：
#    run_shells/train/bigolive_soda/ft_llama7B_prompt_gptLiveSodaSex.sh
#----------------------------------------------------
model_dir = "/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/mask_header/ft_out/checkpoint-1000"
...
if __name__ == '__main__':
    app.run(debug=False, host="202.168.100.165", port=5020)
