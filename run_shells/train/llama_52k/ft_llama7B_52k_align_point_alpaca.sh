...
# 经历对齐 https://github.com/pointnetwork/point-alpaca 来训练
#----------------------------------------------------------
...
your_output_dir="/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/ft_52k/train_output_align_point_alpaca"
