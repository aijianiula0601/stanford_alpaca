...
setproctitle.setproctitle("vicuna7b-ft_v4_v4")
...
model_dir = "/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v4/v5/ft_out/checkpoint-160"
...
if __name__ == '__main__':
    app.run(debug=False, host="0.0.0.0", port=60245)
