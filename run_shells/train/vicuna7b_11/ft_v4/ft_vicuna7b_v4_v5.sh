...
base_dir="/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v4/v5"
llama_ckpt_and_tokenizer="eachadea/vicuna-7b-1.1"
output_dir="${base_dir}/ft_out"
data_json="${base_dir}/train_data.json"
clear_data_json="${base_dir}/train_data_cleaned.json"
...
torchrun --nproc_per_node=8 --master_port=${your_random_port} test_models/vicuna-7b/train.py \
    ...
    --fp16 True \
    --process_name "vicuna7b_ft_v4_v5" \
    --lazy_load \
    --mask_head \
    --mask_question
