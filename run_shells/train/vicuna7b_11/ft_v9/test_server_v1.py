...
setproctitle.setproctitle("vicuna7b-ft_v9_v1")
...
model_dir = '/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v9/v1/ft_out/checkpoint-19'
...
if __name__ == '__main__':
    app.run(debug=False, host="0.0.0.0", port=60291)
