...
data = soda_data_list + persona_chat_data + empathetic_dialogues_data + unnatural_instruction_gpt4_data_list + databricks_dolly_15k_data_list + cnn_dailymail2qas_data_list
random.shuffle(data)
