...
base_dir="/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v14/v1"
llama_ckpt_and_tokenizer="eachadea/vicuna-7b-1.1"
output_dir="${base_dir}/debug"
data_json="${base_dir}/debug_data.json"
...
#python test_models/vicuna-7b/train_mask_control_in_data.py --help
