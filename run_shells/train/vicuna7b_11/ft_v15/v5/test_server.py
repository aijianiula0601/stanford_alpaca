...
setproctitle.setproctitle("vicuna7b-ft_v15_v3_v2")
...
model_dir = "/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v15/v4/ft_out/checkpoint-452"
...
if __name__ == '__main__':
    app.run(debug=False, host="0.0.0.0", port=6154)
