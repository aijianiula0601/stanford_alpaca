...
setproctitle.setproctitle("vicuna7b-ft_v15_topic")
...
model_dir = '/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v15/topic/ft_out/checkpoint-341'
...
if __name__ == '__main__':
    app.run(debug=False, host="0.0.0.0", port=61500)
