...
torchrun --nproc_per_node=8 --master_port=${your_random_port} test_models/vicuna-7b/train_es_server_data.py \
    ...
    --fp16 True \
    --process_name "vicuna-7b-v12" \
    --es_index_name "qas_data" \
    --es_server_url "https://202.168.97.165:9200" \
    --es_user_name "elastic" \
    --es_password "EwelDkaFv8l_VBYO_UDL" \
    --lazy_load \
    --mask_head \
    --mask_question \
