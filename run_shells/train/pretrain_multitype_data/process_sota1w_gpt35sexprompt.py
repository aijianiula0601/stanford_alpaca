...
print("---gpt35_data_list:", len(gpt35_data_list))
...
sota_data_list_1w = json.load(open(sota_f))[:10000]
print("----sota_data_list_1w:", len(sota_data_list_1w))

save_sota1w_gpt35_f = f"{save_dir}/sota_1w_gpt35sex_prompt.json"

print(f"----all_n:{len(gpt35_data_list + sota_data_list_1w)}")
