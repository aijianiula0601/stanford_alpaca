...
save_base_dir = "/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/pretrain_multitype_data_soda_sex_gptsex"
...
gpt35_sex_data_list = json.load(open(org_f))
for example in gpt35_sex_data_list:
    example[DATASET_KEY] = GPT35_SELF_PROMPT_DATASET_NAME

print(f"dataset name:{GPT35_SELF_PROMPT_DATASET_NAME},all_n:{len(gpt35_sex_data_list)}")
...
# 只拿一部分数据
data = soda_data[:40000] + \
       persona_chat_data[:20000] + \
       empathetic_dialogues_data[:20000] + \
