...
output_dir="${base_dir}/ft_outs_continue_checkpoint-5400"
data_json="${base_dir}/multi_dataset_qas.json"

mkdir -p ${output_dir}


torchrun --nproc_per_node=6 --master_port=${your_random_port} test_models/mask_header_answer/train_multi_round_mask_answer_multitype_dataset.py \
    ...
    --fp16 True \
    --process_name "multi_dataset_continue"
