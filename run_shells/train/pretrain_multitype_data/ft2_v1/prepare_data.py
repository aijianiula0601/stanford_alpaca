...
# sharegpt
# ---------------
f = "/mnt/cephfs/hjh/common_dataset/nlp/qa/en/sharegpt/cleaned_gpt4_shared_data_qas.json"

sharegpt_data_list = json.load(open(f))

random.shuffle(sharegpt_data_list)
print(f"sharegpt:{len(sharegpt_data_list)}")
print("-" * 100)
...
all_data_list = sharegpt_data_list[:20000] + gpt35sex_data_list + sexy_data_list + soda_data_list[:40000]

print(f"all_data:{len(all_data_list)}")

save_dir = "/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/pretrain_multitype_data/ft2_v1"
