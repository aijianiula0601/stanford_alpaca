...
your_output_dir="./finetune_out_gpt4_shared_10_multi_new_eos/"

#data_json="./alpaca_data.json"
data_json="./gpt4_shared_data_v4_sp_1948_combine.json"


torchrun --nproc_per_node=8 \
    --master_port=${your_random_port} train_multi_round_new_eos.py  \
