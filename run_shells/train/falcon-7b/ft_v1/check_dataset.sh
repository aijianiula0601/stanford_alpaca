...
base_dir="/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/falcon-7b/ft2_v1"
...
torchrun --nproc_per_node=1 --master_port=${your_random_port} test_models/folcon-7b/multitype_dataset_pre_token.py \
