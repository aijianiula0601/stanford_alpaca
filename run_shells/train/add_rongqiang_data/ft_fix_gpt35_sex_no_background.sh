...
output_dir="${base_dir}/ft_outs_no_background"
data_json="${base_dir}/merge_data.json"

mkdir -p ${output_dir}


torchrun --nproc_per_node=8 --master_port=${your_random_port} test_models/mask_header_answer/train_multi_round_mask_answer_add_end_token_no_background.py \
