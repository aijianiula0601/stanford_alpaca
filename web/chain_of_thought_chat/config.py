...
PROMPT_DIC = {
    "chat": (
        ...
        "```\n"
        "Extract useful information based on last_summary and Latest chat history, focusing on the user's state({user_state}) and intention(user_intention), and respond to the current user's question in less than 30 words.  Reply with empathy, compassion, flirtation, and colloquial language."
    ),
    "intention_state": (
