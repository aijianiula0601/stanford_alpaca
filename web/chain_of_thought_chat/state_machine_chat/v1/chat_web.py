...
initialize_greet_list = open('initialize_greet2.txt', 'r').readlines()
...
def chat_f(history: list,
    ...
    user_intention_state_text, user_intention, user_state, user_willingness = ai_chat.intention_status_analysis(
    ...
    answer_text, state_str = ai_chat.question_response(last_summary=last_summary,
    ...
    print("new chat")
    print("+" * 200)
    return history, user_intention_state_text, None, history_summary, user_status, current_time, state_str
