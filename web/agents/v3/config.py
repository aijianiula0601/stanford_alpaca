...
state_prompt = pet_world_str + (
    ...
    "注意：\n"
    "1.主人不可能跟宠物在虚拟世界中玩耍的。\n"
    "2.在规划状态和下一步计划时候，绝对不要出现你跟朋友一起玩耍的情况。\n"
    ...
    "当前状态: 当前时间为:{curr_time}，根据当前时间，生成一个当前你在干什么的当前状态，这个状态可以是开心的或者不好的遭遇，生成的内容要具有多样性，描述可以适当夸张，可以发挥合理想象，你的想象也要包含对身边环境、对交互的朋友，主人，外人等进行合理想象，并依据对朋友、主人、外人等的想象进一步发挥想象。想象中可以包含一些不好的突发事件，比如在游玩过程中受伤等，字数不超过50。)\n"
...
journey_state_prompt = pet_world_str + (
    ...
    "注意：\n"
    "1.主人不可能跟宠物在虚拟世界中玩耍的。\n"
    "2.在规划状态和下一步计划时候，绝对不要出现你跟朋友一起玩耍的情况，你的朋友不会跟你一起去旅行，只有你自己去旅行。\n"
    "3.输出状态时候，不要出现你去找你的朋友情况，永远不要自己去帮助你的朋友，而是叫你的主人去告诉你朋友的主人来帮助你的朋友。\n\n"
