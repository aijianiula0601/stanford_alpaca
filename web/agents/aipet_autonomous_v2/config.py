...
act_plan_prompt = pet_world_str + (
    ...
    "你的朋友{friend_name}的当前状态为:\n"
    "{friend_state}\n\n"

    "你过往的一些经验记忆:\n"
    "{memory_env}\n\n"

    "根据你当前的状态和你朋友{friend_name}的当前状态、你所处的位置和过往的一些经验记忆，决定你下一步的计划和下一步计划所在位置。输出一个的JSON对象，包括的key为：下一步计划、下一步计划的位置"
    # "你的活动范围只有：你自己的家 或者 去朋友家玩"
)

new_state_prompt = pet_world_str + (
    "你现在是宠物世界的一员，你的名字是{role_name}。\n"
    "以下是你的角色描述:\n"
    "{role_description}\n\n"
    ...
    "你的朋友{friend_name}的下一步的计划为:\n"
    "{friend_next_plan}\n\n"

    "根据你的计划和你朋友的下一步计划，现在你正在实施你的计划，所以输出你当前的状态，限定字数在30个字以内。"
)
