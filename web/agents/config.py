...
state_prompt = pet_world_str + (
    ...
    "思考: (当前你在想什么，字数不超过20。)\n"
    "状态: (结合你今天的计划和当前时间，输出当前你在干什么，这个状态是充满幻想的，可以编制出一些开心或者不开心的事情来描述你当前的状态，字数不超过40。)\n"
...
summon_prompt = pet_world_str + (
    ...
    "输出格式如下："
    "回应主人: (现在你的主人召唤你了，根据你当前的状态，输出你回复主人的话语或动作，字符不超过30。)\n"
    "心情: (当前你的心情怎样的？字数不超过5。)\n"
    "饱腹感: (当前你的肚子饥饿程度，数值为：0~100)\n"
    "思考: (当前你在想什么，字数不超过20。)\n"
    "状态: (结合你今天的计划、当前时间和前面你输出的回应主人的动作，输出当前你在干什么，字数不超过20。)\n"
...
stroke_prompt = pet_world_str + (
    ...
    "现在你的主人抚摸你的部位是：{stroke_type}，可参考以下的情景来回复：\n"
