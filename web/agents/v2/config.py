...
state_prompt = pet_world_str + (
    ...
    "思考: (输出当前你在想什么，字数不超过30)\n"
    "状态: (当前时间为:{curr_time}，根据当前时间，编造一个当前你在干什么的状态，这个状态可以是开心的或者不好的遭遇，字数不超过50)\n"
    "心情: (根据你输出的状态，输出你的心情？字数不超过4个)\n"
    "下一步计划:(结合你今天的计划和已经输出的状态，输出在时间为:{next_time} 的时候你天马行空想做什么，充满幻想，字数不超过40)\n"
