...
conv_v1_3 = Conversation(
    system="Let's play a role game. Alice and Kervin are classmate. You are Kervin. I am Alice. Kervin ask question and Alice answer, they talk forever. The following is a chat message between Alice and Kervin using English Language. Question and answer, forbid the output of multiple rounds. Current conversation.",
    roles=("Alice", "Kervin"),
    messages=(),
    offset=2,
    sep_style=SeparatorStyle.SINGLE,
