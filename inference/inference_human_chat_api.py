...
pdj = "/mnt/cephfs/liujunshi_data/Projects/bigo_stanford_alpaca/lib/transformers_jh/src/"
...
# model_dir = "/data4/GPT_Projects/FastChat/raw_vicuna-7b/vicuna-7b"
# model_dir = "/mnt/cephfs/liujunshi_data/Projects/bigo_stanford_alpaca/trained_models/finetune_out_gpt4_shared/checkpoint-1400"
model_dir = "/mnt/cephfs/liujunshi_data/Projects/bigo_stanford_alpaca/finetune_out_gpt4_shared_10_multi/checkpoint-1400/"
# model_dir = "/mnt/cephfs/liujunshi_data/Projects/bigo_stanford_alpaca/trained_models/finetune_out_gpt4_sexy/checkpoint-900"
# model_dir = "/mnt/cephfs/zhuchengqi/data/aigc/LLM/model_tmp/finetune_gpt4_600"
...
PROMPT_DICT = {
    "conversion": (
        ...
        "{background}. The following is a chat message between {role_a} and {role_b} using English Language. Question and answer, forbid the output of multiple rounds. {role_a} and {role_b} prefer to talk science. Current conversation."
        "{history}"
    ),
