...
for k in tqdm(all_keys):
    ...
    try:
        ...
        for i in range(turn_n):
            ...
            # 模型:/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v5/ft_out/checkpoint-7000
            # --------------------------------
            example['qas'][i]['answer-1'] = my_llama_respond(cur_example, model_name="vicuna-7b_ft_v5",
                                                             if_self_prompt=if_self_prompt)
            # --------------------------------
            # vicuna-7bft multitype+cot数据
            # 模型:/mnt/cephfs/hjh/train_record/nlp/stanford_alpaca/vicuna-7b/ft2_v5_v2/ft_out/checkpoint-6000
            # --------------------------------
            example['qas'][i]['answer-2'] = my_llama_respond(cur_example, model_name="vicuna-7b_ft_v5_v2",
                                                             if_self_prompt=if_self_prompt)
