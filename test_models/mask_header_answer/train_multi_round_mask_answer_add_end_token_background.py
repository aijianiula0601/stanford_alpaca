...
PROMPT_DICT = {
    "header": "Here is a conversation between {role_a} and {role_b} related to the description below. {background} \n\n",
}
...
def _preprocess_example(conversation_dic: Dict, tokenizer: transformers.PreTrainedTokenizer, token_max_len: int):
    ...
    header = PROMPT_DICT['header'].format_map(
        {BACKGROUND_KEY: conversation_dic[BACKGROUND_KEY], "role_a": human_name, "role_b": bot_name})
